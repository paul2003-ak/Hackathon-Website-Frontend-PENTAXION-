          ...
          {TEAM_DATA.map((member, index) => (
            ...
            >
                ...
                >
                    ...
                    <div 
                        // FIX: Adjusted top/right spacing for mobile
                        className="absolute top-4 right-4 md:top-6 md:right-6 flex flex-col gap-2 md:gap-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
