...
const ServiceSummary = () => {
  ...
  // UPDATED: Reusable component for the glowing RED divider
  const RedDivider = () => (
    <div className="w-12 h-[3px] md:w-32 bg-iron-red shadow-[0_0_15px_#FF1F1F]" />
  );
  ...
  return (
    <section className="relative mt-20 overflow-hidden min-h-[60vh] flex items-center justify-center mb-42">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Dark overlay + RED tint to make text pop */}
        <div className="absolute inset-0 bg-line-dark/90 mix-blend-multiply" />
        {/* Changed from green/10 to red/10 */}
        <div className="absolute inset-0 bg-iron-red/10 mix-blend-overlay" />
      ...
      <div className="relative z-10 w-full py-20 text-center text-white uppercase contact-text-responsive font-black tracking-tighter leading-none">
        ...
        >
          <p>Development</p>
          <RedDivider />
          {/* Updated text glow to red */}
          <p className="text-iron-red text-glow">Deployment</p>
        </div>
